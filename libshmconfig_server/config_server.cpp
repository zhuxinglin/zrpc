...
int ConfigServer::Initialize(znet::CLog *pLog, znet::CNet *pN, CSharedData *pProc, CSharedData* pSo)
{
    ...
    m_mapFun.insert(MAP_FUN::value_type(CUtilHash::UriHash(URL_QUERY_LIST, sizeof(URL_QUERY_LIST) - 1), &ConfigServer::Add));
    m_mapFun.insert(MAP_FUN::value_type(CUtilHash::UriHash(URL_MOD_CONFIG, sizeof(URL_MOD_CONFIG) - 1), &ConfigServer::Del));
    m_mapFun.insert(MAP_FUN::value_type(CUtilHash::UriHash(URL_ADD_CONFIG, sizeof(URL_ADD_CONFIG) - 1), &ConfigServer::Mod));
    m_mapFun.insert(MAP_FUN::value_type(CUtilHash::UriHash(URL_DEL_CONFIG, sizeof(URL_DEL_CONFIG) - 1), &ConfigServer::Query));
    return 0;
}
